...
# GLM-5.2 NVFP4 DCP4 + MTP3 runtime for the 2026-06-19 PR #28 global-topk
# diagnostic image. This is the opt-in exact DCP global top-k experiment, not
# the sharded-draft-only "known-good" launcher.
#
# Measured summary for this exact stack:
#   0k C1 93.3 tok/s, 0k C4 276.6 tok/s
#   64k C1 87.7 tok/s, 64k C4 261.2 tok/s
#   weighted sustained MTP acceptance 58.6%
#
# The global-topk route changed sparse candidate ownership substantially, but
# did not improve GLM-5.2 MTP acceptance versus the sharded-draft-only run.

IMAGE="${IMAGE:-voipmonitor/vllm:glm52-dark-devotion-dcp4-mtp3-pr28-globaltopk-cu132-20260619}"
IMAGE_DIGEST="${IMAGE_DIGEST:-sha256:0320510ab4822e17192fa1d02728ad95e586b24d50e6eee5797f4917a79f5cc0}"
NAME="${NAME:-glm52-dcp4-mtp3-pr28-globaltopk}"
PORT="${PORT:-5531}"
